...
def add_subtitles(video_file: str, srt_file: str, output_file: str):
    ...
    subprocess.run([
        'ffmpeg', '-y',
        '-i', video_file,
        '-vf', f'subtitles={srt_file}:force_style=\'FontName={font_name},FontSize=20,PrimaryColour=&HFFFFFF&,OutlineColour=&H000000&,Outline=1,Shadow=0,BorderStyle=1,MarginV=35,BackColour=&H4D000000&\'',
        '-c:v', 'libx264',
        '-preset', 'medium',
        '-crf', '23',
        '-c:a', 'copy',

...
class ComfyUIGenerator:
    def __init__(self, host="127.0.0.1", port="8188"):
        ...
        # 加载工作流配置
        try:
            with open("Testworkflow_api.json", "r", encoding="utf-8") as f:
    ...
    def generate_images(self, key_scenes_file: str):
        ...
        try:
            for scene in scenes:
                ...
                positive_prompt = scene["prompt"] + ", masterpiece, best quality, anime style"
                negative_prompt = "text, watermark, bad quality, worst quality, low quality"
